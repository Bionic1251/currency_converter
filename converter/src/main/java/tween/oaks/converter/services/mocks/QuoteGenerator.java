...
public class QuoteGenerator implements QuoteTickSubscription {
    ...
    private static final double RUB_NZD	= 10.05;
    private static final double GBP_JPY	= 128.26;
    private static final double XAU_USD	= 1425;
    private static final double XAG_USD	= 24;
    private static final double SN1_USD	= 2;
    private static final double OIL_USD	= 2000;
    private static final double DEFAULT_SPREAD = 20;
    private static final double DEFAULT_PIP = 0.0001;
    private static final double JPY_PIP = 0.01;
    private static final long DEFAULT_SIZE = 1000;

    private static int getRandomMillis() {
        return (int) ((Math.random() * 5800) + 500);
    }
    ...
    private void scheduleNextTick(final Tick tick) {
        final Timer timer = new Timer(getRandomMillis(), new ActionListener() {
            @Override
    ...
    private Tick getDefaultTick(String s) {
        switch(s){
            ...
            case "RUBNZD":
                return new Tick(s, RUB_NZD - DEFAULT_SPREAD * DEFAULT_PIP, RUB_NZD + DEFAULT_PIP * DEFAULT_SPREAD, DEFAULT_SIZE, DEFAULT_PIP);
            case "XAUUSD":
                return new Tick(s, XAU_USD - DEFAULT_SPREAD * DEFAULT_PIP, XAU_USD + DEFAULT_PIP * DEFAULT_SPREAD, DEFAULT_SIZE, DEFAULT_PIP);
            case "XAGUSD":
                return new Tick(s, XAG_USD - DEFAULT_SPREAD * DEFAULT_PIP, XAG_USD + DEFAULT_PIP * DEFAULT_SPREAD, DEFAULT_SIZE, DEFAULT_PIP);
            case "SN1USD":
                return new Tick(s, SN1_USD - DEFAULT_SPREAD * DEFAULT_PIP, SN1_USD + DEFAULT_PIP * DEFAULT_SPREAD, DEFAULT_SIZE, DEFAULT_PIP);
            case "OILUSD":
                return new Tick(s, OIL_USD - DEFAULT_SPREAD * DEFAULT_PIP, OIL_USD + DEFAULT_PIP * DEFAULT_SPREAD, DEFAULT_SIZE, DEFAULT_PIP);
            default:
